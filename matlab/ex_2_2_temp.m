...
d1 = ??; % downsample factor for signal x1
d2 = ??; % downsample factor for signal x2
d3 = ??; % downsample factor for signal x3
...
x_orig = ; % signal sampled with odd N
x_cor = ; % corrected signal
